    ...
    <div class="contact-area ptb-100" id="app">
        <div class="container">
            <div class="contact-form">
                <h1>سفارش آنلاین مخصوص مشتری</h1>
                <form action="{{route('Order_customer')}}" method="post">
                    @csrf
                    ...
                    <section>
                        ...
                        <select name="industry" id="" >
                            ...
                            @foreach($industries as $industry)
                                <option @if(old('industry') == $industry->id) selected @endif value="{{$industry->id}}">{{$industry->title}}</option>
                            @endforeach
                        </select>
                        <small class="text-danger">@error('industry') {{$message}}@enderror</small>
                    </section>
                    <section>
                        <p>نوع دستگاه درخواستی</p>
                        <select name="machine" id="" >
                            <option value="">انتخاب کنید...</option>
                            @foreach($machines as $machine)
                                <option @if(old('machine') == $machine->id) selected @endif value="{{$machine->id}}">{{$machine->title}}</option>
                            @endforeach
                        </select>
                        <small class="text-danger">@error('machine') {{$message}}@enderror</small>
